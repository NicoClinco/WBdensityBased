...
(
    ...
    vector& rhoUFlux,
    scalar& rhoEFlux,
    const doubleScalar& pLeft,
    const doubleScalar& pRight,
    const vector& ULeft,
    const vector& URight,
    const doubleScalar& TLeft,
    const doubleScalar& TRight,
    const doubleScalar& RLeft,
    const doubleScalar& RRight,
    const doubleScalar& CvLeft,
    const doubleScalar& CvRight,
    const vector& Sf,
    const scalar& magSf
) const
{
...
// ************************************************************************* //
// Include the flux in the energy.
void Foam::hllcFlux::evaluateFlux
(
    scalar& rhoFlux,
    vector& rhoUFlux,
...
) const
{
    ...
    scalar SLeft = qLeft-aLeft;
    scalar SRight = qRight+aRight;
    // Step 3: compute signal speeds for face:
